...
async function runBetaGroup() {
  console.log('================================================================');
  console.log('🚀 Executing "Group Beta" on Einstein\'s Zebra Puzzle');
  console.log('================================================================');
  console.log('Models in Group Beta (' + GROUP_BETA.length + '):');
  GROUP_BETA.forEach(m => console.log(' - ' + m));

  // Run in triads of 3
  for (let i = 0; i < GROUP_BETA.length; i += 3) {
    const triad = GROUP_BETA.slice(i, i + 3);
  ...
  console.log('\n✨ "Group Beta" benchmark run complete!');
}
