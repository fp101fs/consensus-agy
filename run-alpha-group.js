...
// Cheap Group Alpha Models
const CHEAP_GROUP_ALPHA = [
  'openai/gpt-5.6-luna',
...
async function runAlphaGroup() {
  console.log('================================================================');
  console.log('🚀 Executing "Cheap Group Alpha" on Einstein\'s Zebra Puzzle');
  console.log('================================================================');
  console.log('Models in Group Alpha (' + CHEAP_GROUP_ALPHA.length + '):');
  CHEAP_GROUP_ALPHA.forEach(m => console.log(' - ' + m));

  // Run in triads of 3
  for (let i = 0; i < CHEAP_GROUP_ALPHA.length; i += 3) {
    const triad = CHEAP_GROUP_ALPHA.slice(i, i + 3);
  ...
  console.log('\n✨ "Cheap Group Alpha" benchmark run complete!');
}
